...
public partial class Default2 : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, EventArgs e)
   {
    ...
    {
        int flag = 0;
        TextBox1.BackColor = TextBox2.BackColor= TextBox10.BackColor = DropDownList7.BackColor = DropDownList8.BackColor = DropDownList9.BackColor = TextBox14.BackColor = TextBox15.BackColor = TextBox2.BackColor = TextBox3.BackColor = TextBox4.BackColor = TextBox5.BackColor = TextBox6.BackColor = System.Drawing.Color.White;
        ...
        if(flag==1)
{
        ...
        else
        {
            ...
            string state = Convert.ToString(DropDownList8.Text);
            string country = Convert.ToString(DropDownList9.Text);
            ...
            c1.updatefillinfo(mrn, ssn, fname, lname, dob, gender, bg, race, lang, addr, city, state, country, zip, cno, email,uid);
        }
        }
    bool ReturnValue()
    {
